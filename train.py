...
def train():
    ...
    img_dir = './data/cityscape/img/train'
    label_dir = './data/cityscape/label/train'
    ...
    model.model.fit_generator(generator=dataset.batched_gen(train_gen),
                              steps_per_epoch=32,
                              verbose=1,
                              epochs=2,
                              validation_data=dataset.batched_gen(val_gen, 16),
                              initial_epoch=0,
                              validation_steps=16)
